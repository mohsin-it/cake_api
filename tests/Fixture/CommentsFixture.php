...
class CommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'parent_comment' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'parent_comment' => 1,
                'is_active' => 1,
                'created' => '2018-08-16 19:18:39',
                'modified' => '2018-08-16 19:18:39'
            ],
        ];
        parent::init();
    }
