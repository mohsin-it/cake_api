...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'terms_accepted' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
        ...
        'token' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-07-26 18:45:00',
                'modified' => '2018-07-26 18:45:00'
            ],
        ];
        parent::init();
    }
